...
/////////////////////[[ 전체 조회 하기 소스 추가 ]] /////////////////////////		
	...
	public void initDisplay() {
		...
		Thread th = new TimeClient(jlb_time);//이른 인스턴스화 - 컴파일 순서
	...
	/////////////////////////////////////[[ 조회결과를 처리  ]]////////////////////////////////////
				...
				try {
					...
					if(rs.next()) {
						...
						dVO = new DeptVO();
						dVO.setDeptno(rs.getInt("deptno"));
						System.out.println("조회결과가 있을 때 DB쪽"+rs.getInt("deptno")+" ,  VO쪽"+dVO.getDeptno());
						dVO.setDname(rs.getString("dname"));
						dVO.setLoc(rs.getString("loc"));
					}
					else {
					...
					System.out.println("수정 :"+dVO.getDeptno());
					//오라클 서버와 연동 하여 사용자가 선택한 한 개 로우만 가져온다.
