...
/*
 * java.util에 있는 패키지들은 제공되는 api를 통해서 뭔가를 만들때 유용한 기능들을 모아둔 패키지 임.
...
public class PrintExam {
	...
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in);//local device-서버가 아니다.-동기화는 불가-예전에 데이터를 계속 가지고 있다.-새로등록된 운동선수에 대한 정보가 없다. -FIFA2021
		Scanner sc2 = null;
